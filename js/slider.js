...
function getRightLeft() {
    ...
    if(activeIndex === designs.length-1)
        ...
        right = designs[activeIndex+1];


    if(activeIndex === 0)
        left = designs[designs.length-1];
    else {
...
function getPosition() {
    ...
    designs.forEach((design, index) => {
        if(index === activeIndex) {
            ...
            design.style.transform = 'translateX(-250%)';
        }
...
function getRightSlide(){
    ...
    current.style.transform = 'translate(-250%)';
...
function getLeftSlide(){
    ...
    current.classList.remove('active');
    current.style.transform = 'translateX(250%)';
